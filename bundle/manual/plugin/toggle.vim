...
"
" Usage:
" Drop into your plugin directory, Pressing Control-S toggles
...
imap <C-S> <C-O><Cmd>call Toggle()<CR>
nmap <C-S> <Cmd>call Toggle()<CR>
vmap <C-S> <ESC><Cmd>call Toggle()<CR>gv
